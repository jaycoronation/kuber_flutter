...
class _BookPriestBottomSheetState extends State<BookPriestBottomSheet> {
                                      ...
                                      child: Row(
                                        ...
                                        children: const [
                                          Padding(
                                            ...
                                            child: Text('Next', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: title),),
                                          ),
                                        ],
                                      ),
                                    ),
  ...
  void _setPickDate(TextEditingController controller, StateSetter setState){
  ...
  void _setTimePicker(TextEditingController controller, StateSetter setState){
    showCupertinoModalPopup(
        context: context,
        builder: (BuildContext builder) {
          return Container(
  ...
  bookPujaRequest() async {
    ...
    Map<String, String> jsonBody = {
      ...
      'puja_id' : pujaId,
      'booking_date' : ausoiciousDate ? getCurrentDate() : dateTimeForPass,
